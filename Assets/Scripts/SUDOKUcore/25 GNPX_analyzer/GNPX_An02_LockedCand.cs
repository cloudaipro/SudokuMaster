            ...
            {  //#no
                ...
                {   //   0-8:row 9-17:column
                    ...
                    { //row house
                        ...
                        otherHRC1 = hs / 3 * 3 + (hs + 1) % 3; otherHRC2 = hs / 3 * 3 + (hs + 2) % 3;
                    }
                    else
                    {       //column house
                        ...
                        otherHRC1 = (hs - 9) / 3 * 3 + (hs - 9 + 1) % 3 + 9; otherHRC2 = (hs - 9) / 3 * 3 + (hs - 9 + 2) % 3 + 9;
                    }

                    { //----- found -----
                        SolCode = 2;
                        SolData = otherHRC2 * 1000 + otherHRC1 * 10 + b0;
                        SolData += (hs < 9) ? 200000 : 300000;
