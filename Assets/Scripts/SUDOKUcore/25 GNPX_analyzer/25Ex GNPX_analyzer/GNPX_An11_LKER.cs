...
namespace GNPXcore{
    public partial class NXGCellLinkGen: AnalyzerBaseV2{
        ...
        private void EmptyRectangle_SolResult( int no, int bx, UCellLink PLK, UCell PElm ){
            ...
            //alex PLK.UCe1.Set_CellColorBkgColor_noBit( noB, AttCr, SolBkCr2 );                 //Mark Strong Links
            //alex PLK.UCe2.Set_CellColorBkgColor_noBit( noB, AttCr, SolBkCr2 );                 //Mark Strong Links

            string st =""; 
            foreach( var Q in pBDL.IEGetCellInHouse(bx+18,noB) ){
                //alex  Q.Set_CellColorBkgColor_noBit(noB,AttCr,SolBkCr);   //Empty Rectangle
                st += " "+Q.rc.ToRCString();
            }
