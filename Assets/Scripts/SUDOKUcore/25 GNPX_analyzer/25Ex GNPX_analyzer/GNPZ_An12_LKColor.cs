                ...
                foreach( Bit81[] CRL in _Coloring(no) ){                //_Coloring: cells_network connected by strong-links
                    ...
                    if( HitB.IsNotZero() ){ //===== found =====
                        ...
                        if( SolInfoB ){
                            ...
                            //alex Color Cr =_ColorsLst[1];
                            //alex  Color Cr1 =Cr; Cr1.A=(byte)127;                  //Color.FromArgb(120,Cr.R,Cr.G,Cr.B);  
                            //alex  CRL[0].IE_SetNoBBgColor( pBDL, noB, AttCr, Cr );
                            //alex  CRL[1].IE_SetNoBBgColor( pBDL, noB, AttCr, Cr1 );
                        }
                    ...
                    for(int na=0; na<2; na++ ){
                        ...
                        for(int nb=0; nb<2; nb++ ){
                            ...
                            if(found){
                                ...
                                Result=SolMsg;
                                if( SolInfoB ){
                                    //alex Color CrA = _ColorsLst[4];
                                    //alex foreach ( var P in ELM.IEGet_rc().Select(p=>pBDL[p]) ) P.Set_CellColorBkgColor_noBit(noB,AttCr,CrA);
                                    string st1 = "";
                                    for(int k=0; k<2; k++){
                                        Bit81[] CRLX = MCRL[cmb.Index[k]];
                                        //alex Color Cr1=_ColorsLst[k*2];
                                        //alex Color Cr2 =Cr1; Cr2.A=(byte)100;          
                                        //alex CRLX[1-k].IE_SetNoBBgColor( pBDL, noB, AttCr, Cr1 );
                                        //alex CRLX[k].IE_SetNoBBgColor(   pBDL, noB, AttCr, Cr2 );
                ...
                while(prm.Successor()){
                    ...
                    for(int nb=0; nb<2; nb++ ){
                        ...
                        if( SolInfoB ){
                            ...
                            //alex Color Cr1 = _ColorsLst[0];   
                            //alex Color Cr2 = Color.FromArgb( 100, Cr1.R, Cr1.G, Cr1.B );
                            //alex CRLa[0].IE_SetNoBBgColor( pBDL, noB, AttCr, Cr1 );
                            //alex CRLa[1].IE_SetNoBBgColor( pBDL, noB, AttCr, Cr2 );

                            //alex Cr1 = _ColorsLst[1];   
                            //alex Cr2 = Color.FromArgb( 100, Cr1.R, Cr1.G, Cr1.B );
                            //alex CRLb[1-nb].IE_SetNoBBgColor( pBDL, noB, AttCr, Cr2 );
                            //alex CRLb[nb].IE_SetNoBBgColor(   pBDL, noB, AttCr, Cr1 );
