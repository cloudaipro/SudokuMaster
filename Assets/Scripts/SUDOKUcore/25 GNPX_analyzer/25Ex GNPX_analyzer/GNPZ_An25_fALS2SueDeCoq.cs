...
namespace GNPXcore{
    ...
    public partial class AALSTechGen: AnalyzerBaseV2{
        ...
        private void SuDoQueEx_SolResult( UALS ISPB, UALS ISPR ){
            ...
            if( SolInfoB ){
                //alex ISPB.UCellLst.IE_SetNoBBgColor( pBDL, 0x1FF, AttCr, SolBkCr );    // FreeB_Clr, Digit_Clr, background_Clr
                //alex  ISPR.UCellLst.IE_SetNoBBgColor( pBDL, 0x1FF, AttCr, SolBkCr );
