...
namespace GNPXcore{
    public partial class ALSTechGen: AnalyzerBaseV2{
        ...
        private void ALS_XY_Wing_SolResult( UALS UA, UALS UB, UALS Ustem, int RccAC, int RccBC, int noX, Bit81 elmB ){
            ...
            if( SolInfoB ){
                //alex  UA.UCellLst.IE_SetNoBBgColor( pBDL, RccAC, AttCr, SolBkCr );
                //alex  UB.UCellLst.IE_SetNoBBgColor( pBDL, RccBC, AttCr, SolBkCr2 );
                //alex Ustem.UCellLst.IE_SetNoBBgColor( pBDL, RccAC|RccBC, AttCr, SolBkCr3 );
