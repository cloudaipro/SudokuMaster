                        ...
                        foreach( var ALSout in ALSMan.IEGetCellInHouse(1,noB,Pout,h) ){ //ALS out of Stem Block
                            ...
                            foreach( var ALSin in ALSMan.IEGetCellInHouse(1,noB,B81_P0_block2,18+b0) ){ //ALS in Stem b0
                                ...
                                if(SolFound){
                                    ...
                                    if( SolInfoB ){
                                        //alex P0.Set_CellColorBkgColor_noBit(P0.FreeB,AttCr,SolBkCr2);

                                        //alex ALSin.UCellLst.IE_SetNoBBgColor(  pBDL, 0x1FF, AttCr3, SolBkCr);
                                        //alex ALSout.UCellLst.IE_SetNoBBgColor( pBDL, 0x1FF, AttCr3, SolBkCr);
