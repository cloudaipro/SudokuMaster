    ...
    public partial class NiceLoopGen: AnalyzerBaseV2{
        ...
        private void _NL_SolResult( UCellLink LK0, UCellLink LKnxt, Stack<UCellLink> SolStack, int SolType ){
            ...
            foreach( var LK in SolLst ){
                ...
                //alex if( SolType==1 || (SolType==2 && P2!=P0) )  P2.Set_CellBKGColor(SolBkCr);
                //alex  if(LK.type==S){ P1.Set_CellDigitsColor_noBit(noB,AttCr); P2.Set_CellDigitsColor_noBit(noB,AttCr3); }
                //alex  else {           P2.Set_CellDigitsColor_noBit(noB,AttCr); P1.Set_CellDigitsColor_noBit(noB,AttCr3); }
            }
            //alex if ( SolType==2 ) P0.Set_CellBKGColor(SolBkCr2);    
