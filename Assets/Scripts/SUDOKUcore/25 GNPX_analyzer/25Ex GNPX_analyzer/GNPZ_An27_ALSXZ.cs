...
namespace GNPXcore{
    public partial class ALSTechGen: AnalyzerBaseV2{
        ...
        private void ALSXZ_SolResult( int RCC, UALS UA, UALS UB ){
            ...
            if( SolInfoB ){
                //alex foreach( var P in UA.UCellLst ) P.Set_CellColorBkgColor_noBit(P.FreeB,AttCr3,SolBkCr);
                //alex foreach ( var P in UB.UCellLst ) P.Set_CellColorBkgColor_noBit(P.FreeB,AttCr3,SolBkCr2);
