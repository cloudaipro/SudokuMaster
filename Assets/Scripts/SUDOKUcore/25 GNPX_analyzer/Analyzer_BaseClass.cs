...
namespace GNPXcore
{
    public partial class AnalyzerBaseV2
    {
        ...
        public int SolData { get => pGP.SolData; set => pGP.SolData = value; }
        public int BaseSet { get => pGP.BaseSet; set => pGP.BaseSet = value; }
        public int CoverSet { get => pGP.CoverSet; set => pGP.CoverSet = value; }
        public Bit81 PFinSet { get => pGP.PFinSet; set => pGP.PFinSet = value; }
        ...
        static public readonly Color AttCr = Color.red;
        static public readonly Color AttCr2 = Color.blue; //alex Color.SkyBlue;
        static public readonly Color AttCr3 = Color.green;
        static public readonly Color SolBkCr = Color.yellow;
        static public readonly Color SolBkCr2 = Color.green; //alex Colors.LightGreen; //Aqua;//SpringGreen//Colors.CornflowerBlue;  //FIn
        static public readonly Color SolBkCr3 = Color.blue; //alex Colors.Aqua;　　   //Colors.CornflowerBlue;
        static public readonly Color SolBkCr4 = Color.green; //alex Colors.LawnGreen; //SpringGreen B81P0Hk PaleVioletRed LightSalmon Orchid PaleGreen
        ...
        static private IEnumerable<int> __IEGetCellInHouse(int h)
        { //nx=0...8
