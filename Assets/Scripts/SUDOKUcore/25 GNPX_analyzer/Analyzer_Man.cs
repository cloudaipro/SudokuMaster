...
namespace GNPXcore
{
    //alex  using pRes = Properties.Resources;
    ...
    public class UAlgMethod
    {
        ...
        public UAlgMethod(int pid, string MethodName, int DifLevel, dSolver Method, bool GenLogB = false, dSolver myMethod = null)
        {
            ...
            this.MyMethod = (myMethod == null) ? Method : myMethod;                
        }
    ...
    public class GNPX_AnalyzerMan
    {
        ...
        static private Color _Black_ = Color.black;
        ...
        public GNPX_AnalyzerMan(GNPZ_Engin pGNPX_Eng)
        {
            ...
            SolverLst0.Add(new UAlgMethod(1, "LastDigit", 1, SSingle.LastDigit, myMethod: SSingle.MyLastDigit));
            SolverLst0.Add(new UAlgMethod(2, "TwoDirSingle", 1, SSingle.TwoDirSingle, myMethod: SSingle.MyTwoDirSingle));
          ...
          //SolverLst0.Add( new UAlgMethod( 6, " GeneralLogic",  2, GLTech.GeneralLogic, true) );
            ...
            //  SolverLst0.Add( new UAlgMethod( 6, "LockedCandidate_old", 2, LockedCand.LockedCandidate_old ) );
        ...
        public bool SnapSaveGP(UPuzzle GPX0)
        {
            ...
            try
            {
                ...
                {
                    GNPX_App.GMthdOption["abortResult"] = "Reached the limit of multiple solution searches"; // alex pRes.msgUpperLimitBreak; // Reached the limit of multiple solution searches.
                    return false;
                }
                ...
                // Unique solution
                if (pChild_GPs.Any(P => (P.__SolResultKey == __SolResultKey)))
        ...
        { // Use only time-consuming SuDoKu Algorithm
            ...
            if (timeLimit) GNPX_App.GMthdOption["abortResult"] = "Reached the limit of multiple solution searches"; // alex pRes.msgUpperLimitTimeBreak;
            return timeLimit;
        }
        ...
        public (int, int[]) Execute_Fix_Eliminate(List<UCell> BDLarg)
        ...
        {
            foreach (var P in pBDL.IEGetCellInHouse(h)) P.Set_CellBKGColor(Color.red); //alex P.Set_CellBKGColor(Colors.Violet);
        }
