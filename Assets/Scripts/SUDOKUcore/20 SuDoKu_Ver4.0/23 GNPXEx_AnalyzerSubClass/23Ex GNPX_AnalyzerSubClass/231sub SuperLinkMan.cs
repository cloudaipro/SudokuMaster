    ...
    public partial class SuperLinkMan{
        ...
        private bool _IsLooped(GroupedLink P){
            ...
            while(Q!=null){
                ...
                Q=Q.preGrpedLink as GroupedLink;
                if(++nc>20)  return true;           //Å•Å•Å•Å• ÉoÉO?ÇË Å•Å•Å•Å•
            }
            return false;
        }
		...
		public  void developDisp( int rc0, int no0, USuperLink USLK, bool DevelopB ){
            ...
            foreach( var P in qBDL ){
                ...
                //alex if(noT>0) P.Set_CellColorBkgColor_noBit(     noT, Colors.Red, Colors.LemonChiffon  );
                //alex if (noF>0) P.Set_CellDigitsBkgColorRev_noBit(noF, Colors.Red, Colors.LemonChiffon  );
                /* alex
                if ((noT&noF)>0){
            ...
            //alex qBDL[rc0].Set_CellColorBkgColor_noBit(1<<no0, Colors.Red, Colors.Yellow);

            //alex devWin.Set_dev_GBoard( qBDL, dispOn:false );
