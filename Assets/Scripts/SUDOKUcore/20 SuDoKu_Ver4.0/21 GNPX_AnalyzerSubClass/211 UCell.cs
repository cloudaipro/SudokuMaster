...
namespace GNPXcore
{
    ...
    public class UCell
    { //Basic Cell Class
        static private readonly Color _Black_ = Color.black;
        ...
        public int houseIndex; //(Working variable used in algorithm) //alex
        public _HouseType TypeOfHouse() => (houseIndex < 9) ? _HouseType.row : (houseIndex < 18) ? _HouseType.column : _HouseType.block; //alex
        ...
        public void ECrLst_Add(EColor EC)
        {
            ...
            // alex
            //if (EC.ClrDigitBkg == Color.FromArgb(0xFF, 0xFF, 0xFF, 0x00))
            //    WriteLine($"EC:{EC}");
        }
