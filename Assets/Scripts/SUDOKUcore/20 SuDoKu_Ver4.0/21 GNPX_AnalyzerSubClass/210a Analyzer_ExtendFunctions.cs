...
namespace GNPXcore
{
    ...
    static public class StaticSA
    {
        ...
        static public string ToString_SameHouseComp(this string stOrg)
        {  // new version  
        ...
        static public string ToString_SameHouseComp_Old(this string stOrg)
        {  // new version        
           // Preparation
        ...
        static public string ToString_SameHouseNoComp(this string stOrg)
        {  // new version        
        ...
        static public IEnumerable<UCell> IEGetUCell_noB(this Bit81 BX, List<UCell> pBDL, int noBX)
        { //nx=0...8        
            for (int n = 0; n < 3; n++)
            {
                int bp = BX._BP[n];
