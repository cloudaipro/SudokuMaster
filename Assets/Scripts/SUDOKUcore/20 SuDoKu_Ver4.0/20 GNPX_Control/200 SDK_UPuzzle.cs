...
namespace GNPXcore
{
    ...
    {
        static private System.Random rand = new System.Random(1);
    ...
    public class UPuzzle
    {
        ...
        public int SolCode;
        public int SolData; //alex algorithm use
        public int BaseSet; //alex algorithm use
        public int CoverSet; //alex algorithm use
        public Bit81 PFinSet;  //alex algorithm use
