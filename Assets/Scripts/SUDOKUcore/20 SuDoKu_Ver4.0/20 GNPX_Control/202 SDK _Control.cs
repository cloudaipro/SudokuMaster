...
namespace GNPXcore
{
    ...
    public partial class SDK_Ctrl
    {
        ...
        static public System.Random GRandom = new System.Random();
        ...
        {
            this.pGNP00 = pGNP00;
            //alex Send_Progress += new SDKEventHandler(pGNP00win.BWGenPrb_ProgressChanged);
...
#endif
            GRandom = null;
            GRandom = new System.Random(randomSeedVal);
        }
        ...
        public List<UCell> GeneratePuzzleCandidate()
        {      // Generate puzzle candidate
        ...
        //====================================================================================
        public void SDK_PuzzleMaker_Real(CancellationToken ct)
        { //Creating problems[Automatic]
        ...
        #region Analizer
        public void Analyzer_Real(CancellationToken ct)
        {      //Analysis[step]
            try
            {
        ...
        public void Analyzer_RealAuto(CancellationToken ct)
        {   //Analysis[solveUp]
            try
            {
                LoopCC++; TLoopCC++;
