...
namespace GNPXcore
{
    ...
    {                        // This class-object is unique in the system.
        ...
        public GNPZ_Engin(GNPX_App pGNP00)
        {           //Execute once at GNPX startup.
        ...
        public bool Set_NextStage(int _stageNo = -1, bool setAllCandidates = true)
        {      // update the state and create the next stage.
            UPuzzle GPtmp = null;
            ...
            {
                GPtmp = pGP_Initial;
                AnMan.Update_CellsState(GPtmp.BDL, setAllCandidates);
            }
            else
            {
