...
namespace GNPXcore
{
    public partial class SDK_Ctrl
    {
        ...
        public int[] GenSolPatternsListA(bool RandF, int GenLSTyp)
        {  //for Parallel
#if DEBUG
        ...
        public IEnumerable<_LSpattern> GenerateLatinSqure0A(bool RandF)
        {
            ...
            LNxtLevel:
                ...
                {                         //Fill blocks 5,6,8,9 to generate latinSol99(latin square)
        ...
        public IEnumerable<int[]> GenerateLatinSqure0B(bool RandF)
        { //#### In development
            int RX = 3, pn;
            int[,] Sol99 = new int[9, 9];
