...
namespace GNPXcore
{
    ...
    public class GNPX_App
    {
        ...
        //alex public GNPZ_Graphics SDKGrp;             //board bitmap
        ...
        //alex public PuzzleTrans PTrans;             //Transform 
        ...
        {            
            ...
            //alex PTrans = new PuzzleTrans(this);
        ...
        public void SDK_FileOutput(string fName, bool append, bool fType81, bool SolSort, bool SolSet, bool SolSet2, bool blank9)
        {
            ...
            using (StreamWriter fpW = new StreamWriter(fName, append, Encoding.UTF8))
            {
                foreach (var P in qry)
                {
                    ...
                    { //problem_name and Solution(tytpe:matrix)
        ...
        private string _loadMethodFile()
        {
            try
            {
                var methods = Resources.Load(SDK_MethodsFileName) as TextAsset;
                string fs = methods.text;
                //Debug.Log(fs);
                return fs;
            }
            catch (Exception ex)
        ...
        public List<UMthdChked> GetMethodListFromFile()
        {
            ...
            //var methods = Resources.Load(SDK_MethodsFileName) as TextAsset;
            //string fs = methods.text;
            string fs = _loadMethodFile();
            string[] fLines = Regex.Split(fs, "\n|\r|\r\n");
            fLines.ForEach(st =>
            {
                if (st.Contains("abortResult") || st.Trim() == "") return;
                bool bChk = true;
